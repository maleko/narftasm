...
- **MP5 Slap Safety** — NO microswitch on A2 acts as a bolt-lock safety.
  Firing is disabled whenever the bolt is open (pin LOW). When the bolt
  is locked (pin HIGH via pullup), firing is permitted.
