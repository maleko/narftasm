...
- Branch naming MUST be in the format of 'feat/{linear-issue-id}-{short-description}'. This is to ensure that the branch is easily identifiable and can be easily merged into main.
